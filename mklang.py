...
("S_BATT",     "BATERIE","BATTERY","BATERIA","BATTERIE"),
 ("S_BATT_LIFE", "ŽIVOTNOST", "LIFETIME", "ŻYWOTNOŚĆ", "LEBENSDAUER"),
...
("INV_EFF_RANGE", "Minimum / maximum", "Minimum / maximum", "Minimum / maksimum", "Minimum / Maximum"),
 ...
 ("ERR_PV_VOLTAGE", "Vysoké napětí FV (stav)", "High PV voltage (status)", "Wysokie napięcie PV (stan)", "Hohe PV-Spannung (Status)"),
 ...
 ("PV_VOLT_LIMIT", "FV ikona nad", "PV icon above", "Ikona PV powyżej", "PV-Symbol über"),

...
# id, CZ, EN, PL, DE
T = [
 ("APP",        "Solar Assistant","Solar Assistant","Solar Assistant","Solar Assistant"),
 ...
 ("NET_SCAN",   "SKEN SÍTĚ  (trvá až minutu)","NETWORK SCAN  (up to a minute)","SKAN SIECI  (do minuty)","NETZ-SCAN  (bis 1 Min)"),
 ...
 ("SCAN_DONE",  "sken hotov, nalezeno %d zařízení","scan done, %d devices found","skan gotowy, znaleziono %d","Scan fertig, %d gefunden"),
